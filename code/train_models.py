...
def create_barplot(dict, model_name, dir, train=False):
    """Creates a bar plot of model performance metrics and saves it as a png.

    Args:
        dict (Dict): performance metrics generated by sklearn.metrics.classification_report
        model_name (str): the name of the model
        dir (Path): the directory where the image is saved
        train (bool): controls whether the chart title says "Training Data" or "Test Data" 
    """
    status = "Test"
    if train:
        status = "Training"
